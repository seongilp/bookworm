  ...
  <div>
    ...
    <div class="relative mb-5">
      ...
      <input
        ...
        class="h-12 w-full rounded-2xl border border-input bg-secondary/50 pl-11 pr-4 text-sm transition-colors placeholder:text-muted-foreground focus-visible:bg-background focus-visible:outline-none focus-visible:border-foreground/25 focus-visible:ring-2 focus-visible:ring-foreground/[0.05]"
      />
    </div>
